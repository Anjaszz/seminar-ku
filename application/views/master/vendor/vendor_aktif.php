...
<div class="row">
    ...
    <?php echo anchor("master/vendor/nonaktifkan/{$r->id_vendor}", "<i class='feather icon-x'></i>Nonaktifkan Akun", [
        'class' => 'btn btn-sm btn-gradient-danger',
        'onclick' => "return confirm('Apakah Anda yakin ingin menonaktifkan vendor ini?')"
    ]) ?>
</td>
