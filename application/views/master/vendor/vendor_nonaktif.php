...
<div class="row">
    ...
    <?php echo anchor("master/vendor/aktifkan/{$r->id_vendor}", "<i class='feather icon-check-circle'></i>Aktifkan Akun", [
        'class' => 'btn btn-sm btn-gradient-success',
        'onclick' => "return confirm('Apakah Anda yakin ingin mengaktifkan vendor ini?')"
    ]) ?>
</td>
