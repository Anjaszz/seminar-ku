...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2024 at 10:58 AM
...
(8, 'semianr bisnis digital', '2025-02-25 08:00:00', 'a7fd84bf9361a0c2ede1824816d4e1c0.png', 'sertifikat_1729688502.jpg', '');
...
(1, '127.0.0.1', 'administrator', '$2y$12$RsDIoS9EpYmBywqcvlYAsOYWc8AYGdpTJbNYf/eyWHVMY.VDg/uC6', 'sistemmanajemenseminar@gmail.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1730886338, 1);
...
--
ALTER TABLE `pendaftaran_seminar`
  MODIFY `id_pendaftaran` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=351;

--
-- AUTO_INCREMENT for table `presensi_seminar`
--
ALTER TABLE `presensi_seminar`
  MODIFY `id_presensi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;
